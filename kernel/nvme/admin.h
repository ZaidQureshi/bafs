...
struct iobuf* create_io_buf(struct admin_queue_pair* aqp, const u64 page_size, const u64 pages_per_entry, const u64 num_entries);

void delete_io_buf(struct admin_queue_pair* aqp, const void* vaddr);
